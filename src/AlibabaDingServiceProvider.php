...
//    protected $file_name = 'create_table_oss_url.php';
    ...
    public function boot(Filesystem $filesystem)
    {
        ...
        # 发布控制器 demo
        $this->publishes([
            __DIR__ . '/Ding/Controllers/LoginDingController.php' => app_path('Http/Controllers/LoginDingController.php'),
            __DIR__ . '/Ding/Controllers/ComLoginDingController.php' => app_path('Http/Controllers/ComLoginDingController.php'),
        ], 'controller');
    }
